define(["require", "exports", "./lib/typescriptServices", "./lib/lib"], function (require, exports, ts, lib_1) {
    ...
    })(CodeOutlineTokenKind = exports.CodeOutlineTokenKind || (exports.CodeOutlineTokenKind = {}));
            ...
            if (program) {
                ...
                if (currentFile_1) {
                    ...
                    var extractLiteral_1 = function (liternalNode) {
                        ...
                        if (didExtractLiteral) {
                            ...
                            tokens.push({
                                ...
                                ordinal: ordinal_1,
                                line: (currentFile_1 === null || currentFile_1 === void 0 ? void 0 : currentFile_1.getLineAndCharacterOfPosition(liternalNode.getStart()).line) || 0,
                    ...
                    var extractClass_1 = function (classNode) {
                        ...
                        if (classNode.name) {
                            tokens.push({
                                ...
                                ordinal: ordinal_1,
                                line: (currentFile_1 === null || currentFile_1 === void 0 ? void 0 : currentFile_1.getLineAndCharacterOfPosition(classNode.getStart()).line) || 0,
                                indentAmount: indentation_1
                            });
                        }
                        else {
                    ...
                    var extractMethod_1 = function (methodNode) {
                        ordinal_1++;
                        var node = methodNode;
                        var line = (currentFile_1 === null || currentFile_1 === void 0 ? void 0 : currentFile_1.getLineAndCharacterOfPosition(methodNode.getStart()).line) || 0;
